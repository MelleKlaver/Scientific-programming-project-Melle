...
I perform an univariate regression on the full offensive performance to see which individual stat has the highest effect on offensive points.
...
Stats_of_Interest = c(9:21,51,52)
...
Now I try the same but with a multivariate regression approach. This ensures
...
# Assuming "Stats_of_Interest" is a list of numeric variables within "Offensive_gamelog_Combined"
...
ggplot(data = correlation_data, aes(Var1, Var2, fill = value)) +
  geom_tile() +
  scale_fill_gradient(low = "red", high = "blue", limits = c(-1, 1)) + # Adjust colors as needed
