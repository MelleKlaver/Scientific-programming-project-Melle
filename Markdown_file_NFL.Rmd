...
The following code creates the passer rating. It incorporates succesful passing percentage, yards per pass, touchdowns per pass and interceptions per pass. Scores are between 0 and 158.3 
```{r Passer rating}
