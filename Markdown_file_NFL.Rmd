...
print(regression_results_Offense, row.names=FALSE)
...
Age_stats_Columns_QB = c(15,17,20,21,23,31:33)
...
plot = ggplot(data = Age_stats_QB, aes(x = Age)) +
  ...
  geom_line(aes(y = Passer.Rating2.0 / 100, color = "Passer.Rating2.0"), linetype = "solid") +
...
custom_colors = c("Ints" = "blue", "Rushing Attempts" = "red", "Sacks" = "green", "Passes Attempted" = "purple", "Offensive Points" = "orange", "Passer.Rating2.0" = "black" )
