...
Since Passer rating does not include the entire skillset of a QB I have extended the function to include rushing, sacks and fumbles creating Passer rating2.0. Scores are more centered and are between 0 and 158.3
...
ggplot(Quarterback_gamelogs, aes(x = Passer.Rating)) +
  ...
  labs(x = "Passer Rating (Binned)", y = "Count") +
  theme_minimal() +
...
pc1_pc2_plot_PasserRating = ggplot(as.data.frame(pca_result$x), aes(x = PC1, y = PC2, color = Career_stats_average$Amount_of_games_Category)) +
  geom_point() +
...
pc1_pc2_plot_Games = ggplot(as.data.frame(pca_result$x), aes(x = PC1, y = PC2, color = Career_stats_average$Passer.Rating2.0_Category)) +
  geom_point() +
...
print(pc1_pc2_plot_PasserRating)
